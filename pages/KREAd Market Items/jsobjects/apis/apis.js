export default {
	dataPath: "/custom/vstorage/data/published.kread.market-items.".concat(tbl_wallets.selectedRow.item),
	myVar2: {},
	height: 1,
	walletId: "1",
	slash: "\\",
	...
	async getRpcWalletData () {
		...
		this.dataPath = "/custom/vstorage/data/published.kread.market-items.".concat(tbl_wallets.selectedRow.item);
