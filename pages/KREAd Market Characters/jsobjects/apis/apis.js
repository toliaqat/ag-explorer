export default {
	dataPath: "/custom/vstorage/data/published.kread.market-characters.".concat(tbl_wallets.selectedRow.character),
	myVar2: {},
	height: 1,
	walletId: "1",
	slash: "\\",
	...
	async getRpcWalletData () {
		...
		this.dataPath = "/custom/vstorage/data/published.kread.market-characters.".concat(tbl_wallets.selectedRow.character);
